...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 gap-4">
        ...
        <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col justify-center text-center">
            <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-2">Market Timeline</h3>
            <div class='t-badge-base {{ $record->timeline_color }} !text-lg !py-4 !w-auto !h-auto !min-w-[150px]'>
    ...
    <!-- Thermal Breakdown -->
    <div class="p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm">
        <h3 class="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-6 border-b border-gray-50 dark:border-gray-700 pb-2">Thermal Heat Map</h3>
        ...
        <div class="grid gap-6">
            ...
            <div class='flex items-center justify-between text-gray-700 dark:text-gray-300'>
                <div class='flex items-center gap-3'>
                    ...
                    <span class="text-sm font-bold">Active Interaction</span>
                </div>
            ...
            <div class='flex items-center justify-between text-gray-700 dark:text-gray-300'>
                <div class='flex items-center gap-3'>
                    ...
                    <span class="text-sm font-bold">Purchasing Power</span>
                </div>
            ...
            <div class='flex items-center justify-between text-gray-700 dark:text-gray-300'>
                <div class='flex items-center gap-3'>
                    ...
                    <span class="text-sm font-bold">Property Match</span>
                </div>
