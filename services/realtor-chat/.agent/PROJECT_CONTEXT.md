...
*   **Contratos**: Pydantic (definidos en [ui.py](file:///srv/web/services/realtor-chat/backend/app/schemas/ui.py)).
...
---
*Si necesitas detalles sobre qué hacer a continuación, consulta el [IMPLEMENTATION_PLAN.md](file:///srv/web/services/realtor-chat/.agent/IMPLEMENTATION_PLAN.md).*
